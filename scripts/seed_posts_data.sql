...
UPDATE posts SET image_url = CASE id
        WHEN 'd0000000-0000-4000-8000-000000000001' THEN 'http://127.0.0.1:3001/testimg/iphone14.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000002' THEN 'http://127.0.0.1:3001/testimg/textbooks.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000003' THEN 'http://127.0.0.1:3001/testimg/miband8.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000004' THEN 'http://127.0.0.1:3001/testimg/legion-y7000.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000005' THEN 'http://127.0.0.1:3001/testimg/desk-shelf.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000007' THEN 'http://127.0.0.1:3001/testimg/bike-commute.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000010' THEN 'http://127.0.0.1:3001/testimg/badminton-racket.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000023' THEN 'http://127.0.0.1:3001/testimg/board-games.jpg'
        WHEN 'd0000000-0000-4000-8000-000000000024' THEN 'http://127.0.0.1:3001/testimg/desk-lamp.jpg'
