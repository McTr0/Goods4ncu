...
| `kind` | `goods_offer | goods_seek | companion | activity` | 数据库 CHECK 与 service 枚举共同约束；`help` 已移除，求助内容由普通 `posts` 的分类和标签承载 |
